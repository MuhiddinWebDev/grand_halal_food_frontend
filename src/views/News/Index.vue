<script setup>
import { ref, onMounted, watch, watchEffect, reactive, h, computed, inject } from "vue";
import { useMagicKeys } from "@vueuse/core";
import { NButton, NIcon, useDialog, useMessage,NImage } from "naive-ui";
...
const tableColumn = computed(() => [
    ...
    },
    {
        ...
        fixed: 'left',
        render(row) {
            return dayJS(row.datetime * 1000).format('YYYY-MM-DD HH:mm')
        }
    },
    {
        title: t('title') + ' UZB',
